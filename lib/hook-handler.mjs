...
const ROUTING_REMINDER = [
  ...
  'After clarification, select Q0 inline, Q1 Luna review, Q2 Terra review, or Q3 Terra plus Sol verification; use the controller test and close commands so ledger-backed completion has a current .workflow/closure.json.',
